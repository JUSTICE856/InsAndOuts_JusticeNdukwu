...
////FOR THIS FINAL IM CHANGING ALL THE NAVIGATION IN THE GAME AS WELL AS IMPLEMENTING SUGGESTIONS FROM CLASSMATES.
...
void keyPressed() { //////Navigate through levels using the LEFT and RIGHT arrow keys
